...
int	uncle ( int x, int y )
{
	...
	if ( node[x].father != -1 && node[y].father != -1 )
		if ( node[node[x].father].father == node[node[y].father].father  )
			return 0;
	if ( node[x].mother != -1 && node[y].father != -1 )
		if ( node[node[x].mother].father == node[node[y].father].father )
			return 0;
	if ( node[x].father != -1 && node[y].mother != -1 )
		if ( node[node[x].father].father == node[node[y].mother].father )
			return 0;
